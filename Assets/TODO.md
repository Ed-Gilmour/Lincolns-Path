Handle assassination key saying didn't actually happen although technically did (If loss before should have or additional registering other event for timeline instead of loss event?)
